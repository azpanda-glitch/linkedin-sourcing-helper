...
// Early-career postings should match how people actually phrase it.
const INTERN_TERMS = ["intern", "interns", "internship"];
...
export function buildQueries(ext) {
  ...
  return {
    ...
    hiringManager: [
      ...
      { label: "Exact title (verbatim)", url: exactTitleUrl(ext) },
